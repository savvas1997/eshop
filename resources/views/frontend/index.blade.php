                ...
                <div class="products">
                  <div class="hot-deal-wrapper">
                    <div class="image"> <img src="{{asset($product->product_thambnail)}}" alt=""> </div>
                        ...
                        <div class="sale-offer-tag" style="background-color: cornflowerblue"><span>new</span></div>
                ...
                <div class="product-slider">
                  <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                   ...
                   @endphp
                    ...
                    <!-- /.item -->
                    @empty
                       <h5 class="text-danger"> No Product Found
                       </h5> 
                    @endforelse
      ...
      <!-- ============================================== Skip Product 0 ============================================== -->
          ...
          <section class="section featured-product wow fadeInUp">
            <h3 class="section-title">
              @if(session()->get('language')=='greek')
              {{$skip_category_0->category_name_gr}}
        ...
        <!-- ============================================== Skip Product 1 ============================================== -->
            ...
            <section class="section featured-product wow fadeInUp">
              <h3 class="section-title">
                @if(session()->get('language')=='greek')
                {{$skip_category_1->category_name_gr}}
