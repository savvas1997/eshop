          ...
          <div class="cnt-account">
            <ul class="list-unstyled">
              ...
              <li>
                ...
                @auth
                <a href="{{route('dashboard')}}"><i class="icon fa fa-user"></i>{{Auth::user()->name}} Profile</a></li>
                @else
            ...
            <ul class="list-unstyled list-inline">
              ...
              <li class="dropdown dropdown-small"> <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><span class="value">
                ...
                <ul class="dropdown-menu">
                  ...
                  @else
                  <li><a href="{{route('greek.language')}}">Ελληνικά</a></li>
                  @endif
                </ul>
              </li>
            </ul>
              ...
              <div class="nav-outer">
                <ul class="nav navbar-nav">
                     <li class="active dropdown yamm-fw"> <a href="{{url('/')}}" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">
                      @if(session()->get('language')=='greek') Αρχικη
                      @else
                        Home
                        @endif
                      </a> 
