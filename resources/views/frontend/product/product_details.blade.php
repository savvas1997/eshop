...
@endphp
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							...
							<div class="rating-reviews m-t-20">
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="reviews">
											<a href="#" class="lnk">({{$reviewcount->count()}} Reviews)</a>
										</div>
									</div>
								</div><!-- /.row -->		
							</div><!-- /.rating-reviews -->
							...
							{{-- ////Add Color And Product Color And Product Size --}}
							<div class="row">
									
								<div class="col-sm-6">
									<div class="form-group">
										@if(session()->get('language')=='greek')
										<label class="info-title control-label">Διαλεξε Χρώμα <span></span></label>
										<select class="form-control unicase-form-control selectpicker" style="display:none;" id="color">
											<option selected="" disabled="">--Choose Color--</option>
											@foreach($product_color_gr as $color)
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										@else
											...
											@if(session()->get('language')=='greek')
												<label class="info-title control-label">Διαλεξε Μέγεθος <span></span></label>
												<select class="form-control unicase-form-control selectpicker" style="display:none;" id="size">
													<option selected="" disabled="">--Διαλεξε Μέγεθος--</option>
													@foreach($product_size_gr as $size)
						...
						{{-- ////END  Color And Product Color And Product Size --}}
		...
		<div class="product-tab">
			...
			<div class="product-reviews">
				...
				<div class="reviews">
					...
					<div class="review">
						...
						<div class="row">
							<div class="col-md-6">
								<img style="border-radius:50%" src="{{(!empty($review->user->profile_photo_path))? url
									('upload/user_images/'.$review->user->profile_photo_path): url('upload/no_image.jpg')}}" height="40px" width="40px"><b>{{$review->user->name}}</b>
			...
			<div class="product-add-review">
				...
				<div class="review-form">
					...
					@guest
						<p><b>To Add product review, you have to log in first <a href="{{route('login')}}">Login Here</a></b></p>
					@else
			...
			<div class="products">
				...
				<div class="product">		
					<div class="product-image">
						<div class="image">
							<a href="{{url('product/details/'.$product->id.'/'.$product->product_slug_en)}}"><img  src="{{ asset($product->product_thambnail)}}" alt=""></a>						</div><!-- /.image -->			
