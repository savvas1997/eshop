			...
			<div class="blog-page">
				<div class="col-md-9">
					...
					<div class="blog-post  wow fadeInUp">
                        <a href="blog-details.html"><img class="img-responsive" src="{{asset($blog->image)}}" alt=""></a>
                        <h1><a href="blog-details.html">@if(session()->get('language')=='greek'){{$blog->title_gr}} @else {{$blog->title_en}}  @endif</a></h1>
                        
                        <span class="date-time">{{Carbon\Carbon::parse($blog->created_at)->diffForHumans()}}</span>
                        <p>@if(session()->get('language')=='greek'){!! Str::limit($blog->details_gr, 200) !!} @else {!! Str::limit($blog->details_en, 200) !!}  @endif</p>
