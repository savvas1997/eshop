            ...
            <div class="col-md-4"> 
               <ul class="list-group">
                  ...
                  <li class="list-group-item">Stock: 
                     <span class="badge badge-pill budge-success" id="available" style="background: green; color:white;"></span>
                     <span class="badge badge-pill budge-danger" id="stockout" style="background: red; color:white;"></span>
                  </li>
               </ul>
            </div> 
            <div class="col-md-4"> 
               <div class="form-group">
                ...
                <div class="col-auto">
                  ...
                  <button type="submit" class="btn btn-primary mb-2" id="stock" onclick="addtoCart()">Add to Cart</button>
                </div>
            </div> 
         </div>
...
<script type="text/javascript">
                     ...
                     rows +=`<tr>
                           ...
                           <td class="col-md-2">
                              <button class="btn btn-primary icon" type="button" title="Add Cart" data-toggle="modal" 
                                 data-target="#exampleModal" onclick="productView(this.id)" id="${value.product_id}"> 
                                    Add To Cart
                               </button>
                           </td>
   ...
   function wishlistremove(id){
      $.ajax({
         ...
         dataType:'json',
         success:function(data){
            wishlist(); //with this add when i make an action the result apears imidiately without the need of refress the page
            const Toast = Swal.mixin({
               toast:true,
               position: 'top-end',
               showConfirmButton: false,
