                          ...
                          <div class="row"> 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_name_gr" class="form-control" value=" {{$products->product_name_gr}}"> 
                          ...
                          <div class="row"> 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_tags_en" class="form-control" value="{{$products->product_tags_en}}" 
                          ...
                          <div class="row"> 
                            <div class="col-md-4">
                                <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_tags_gr" class="form-control" value="{{$products->product_tags_gr}}" 
                                            data-role="tagsinput" placeholder="add tags"> 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_size_en" class="form-control" value="{{$products->product_size_en}}" 
                                        data-role="tagsinput" placeholder="add tags"> 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <h5>Product Size EN<span class="text-danger">*</span></h5>
                                    <div class="controls">
                                        <input type="text" name="product_size_gr" class="form-control" value="{{$products->product_size_gr}}" 
                                        data-role="tagsinput" placeholder="add tags"> 
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_color_gr" class="form-control" value="{{$products->product_color_gr}}" 
                                            data-role="tagsinput" placeholder="add tags"> 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="short_descp_en" id="short_descp_en" class="form-control" required="" placeholder="Textarea text">
                            ...
                            <div class="col-md-6">
                                ...
                                <h5>Product Short Description GR<span class="text-danger">*</span></h5>
                                    <div class="controls">
                                        <textarea name="short_descp_gr" id="short_descp_gr" class="form-control" required="" placeholder="Textarea text">
                                            {!! $products->short_descp_gr!!}
                                        </textarea>
                                    </div>
                                </div>
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-md-6">
                                ...
                                <h5>Product Long Description GR<span class="text-danger">*</span></h5>
                                    <div class="controls">
                                        <textarea name="long_descp_gr" id="editor2"  rows="10" cols="80" required="" placeholder="Textarea text">
                                            {!! $products->long_descp_gr!!}
                                        </textarea>
                                    </div>
                                </div>
            ...
            <div class="col-md-12">
				<div class="box bt-3 border-info">
				  <div class="box-header">
					<h4 class="box-title">ThumbNail Image Update</h4>
				  </div>
                        ...
                        <div class="row row-sm">
                            <div class="col-md-3">
                                ...
                                <div class="card" style="width: 18rem;">
                                    <img src="{{asset($products->product_thambnail)}}" class="card-img-top" style="weight:280px; height:130px;">
                                    <div class="card-body">
                    ...
                    <form method="post" action="{{route('update-product-image')}}" enctype="multipart/form-data">
                        ...
                        <div class="row row-sm">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card" style="width: 18rem;">
                                    <img src="{{asset($img->photo_name)}}" class="card-img-top" style="weight:280px; height:130px;">
                                    <div class="card-body">
                                      <h5 class="card-title">
