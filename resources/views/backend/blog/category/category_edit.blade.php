                        ...
                        <form method="post" action="{{route('blogcategory.update')}}">
                            ...
                            <input type="hidden" name="id" value="{{$blogcategory->id}}">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input  type="text" name="blog_category_name_en" class="form-control" required="" value="{{$blogcategory->blog_category_name_en}}"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="blog_category_name_gr" class="form-control" required="" value="{{$blogcategory->blog_category_name_gr}}">
